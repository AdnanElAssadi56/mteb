...
# 16 kHz: vision_config.audio_sample_rate — https://huggingface.co/LanguageBind/LanguageBind_Audio_FT/blob/main/config.json
...
class LanguageBindVideoWrapper(_LanguageBindBase):
    ...
    def __init__(
        ...
        # 8 frames: 8-frame clips — https://github.com/PKU-YuanGroup/LanguageBind
