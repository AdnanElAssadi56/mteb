...
class VoiceCLAPSmallWrapper(AbsEncoder):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # VoiceCLAP expects 16 kHz mono waveforms. The checkpoint declares no
        # input-length limit, so no cap is applied here.
        # https://huggingface.co/VoiceNet/voiceclap-large
