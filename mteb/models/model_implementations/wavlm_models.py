...
class WavlmWrapper(AbsEncoder):
    def __init__(
        ...
        # mteb-side memory guard, NOT a native limit. WavLM is a
        # variable-length conv+transformer encoder trained on LibriSpeech/GigaSpeech/VoxPopuli utterances; its
