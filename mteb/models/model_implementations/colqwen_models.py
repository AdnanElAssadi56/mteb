...
class ColQwen2_5OmniWrapper(ColPaliEngineWrapper):  # noqa: N801
    ...
    def __init__(
        ...
        # Uncapped on purpose, and equivalent to 300 s in practice: ColQwen-Omni
        # is built on Qwen2.5-Omni, whose feature extractor declares
        # `chunk_length: 300` and truncates longer input itself. (Note the
        # authors' own demo chunks podcasts at 30 s -- that is an application
        # pattern for retrieval granularity, not an encoder limit.)
